    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ModelState.AddModelError(string.Empty, "The email doesn't correspond to a registred user.");
                    return View(model);
                }
                ...
                if (response.IsSuccess)
                {
                    this.ViewBag.Message = "The instructions to recover your password have been sent through email.";
                }
